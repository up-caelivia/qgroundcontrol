...
Rectangle {
    ...
    Component.onCompleted: {
        ...
        if(Constants.developer)
            ...
            showPanel(parameterButton, "SetupParameterEditor.qml")
    ...
    QGCFlickable {
        ...
        ColumnLayout {
            ...
            Repeater {
                ...
                visible:                _corePlugin && _corePlugin.options.combineSettingsAndSetup && Constants.developer
                SubMenuButton {
            ...
            SubMenuButton {
                ...
                setupIndicator:     false
                exclusiveGroup:     setupButtonGroup
                visible:            !ScreenTools.isMobile && _corePlugin.options.showFirmwareUpgrade && Constants.developer
                text:               qsTr("Firmware")
                Layout.fillWidth:   true
            ...
            SubMenuButton {
                ...
                exclusiveGroup:     setupButtonGroup
                visible:            _fullParameterVehicleAvailable && joystickManager.joysticks.length !== 0 && Constants.developer
            ...
            Repeater {
                ...
                function getModel() {
                    ...
                    var model = QGroundControl.multiVehicleManager.activeVehicle.autopilot.vehicleComponents
                    ...
                    for (var i=0; i < model.length; i++){
                        if(Constants.settingToShow.includes(model[i].name))
                            newModel.push(model[i])
                        //console.log(model[i].iconResource)
                    }
