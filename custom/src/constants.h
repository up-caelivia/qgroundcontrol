...
public:
    ...
    QVector<QString> factNames() const { return {"LOIT_SPEED", "WPNAV_SPEED", "WPNAV_SPEED_DN", "WPNAV_SPEED_UP", "WP_YAW_BEHAVIOR"}; }
    QVector<QString> factDescription() const { return {"Maximum speed reached by drone in loiter mode. Warning: in altitude hold mode speed is not limited", "Maximum horizontal speed reached by drone during automatic mission", "Maximum descending speed reached by drone during automatic mission", "Maximum ascending speed reached by drone during automatic mission",""}; }
    QVector<QString> factGoodNames() const { return {"Maximum loiter speed", "Maximum horizontal auto speed", "Auto mode speed down", "Auto mode speed up", "Auto mode yaw behaviour"}; }
