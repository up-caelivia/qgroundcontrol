...
Rectangle {
    ...
    visible:            _noGPSLockVisible || _prearmErrorVisible || CustomPlugin.speedMessage.length > 0
    ...
    Column {
        ...
        QGCLabel {
            anchors.horizontalCenter:   parent.horizontalCenter
            visible:                    CustomPlugin.speedMessage.length > 0
            color:                      "black"
            font.pointSize:             ScreenTools.largeFontPointSize
            text:                       CustomPlugin.speedMessage
        }
