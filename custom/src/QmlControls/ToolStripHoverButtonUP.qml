...
Button {
    ...
    property color _currentContentColor: (checked || pressed) ? (Constants.isABLUOApp ? qgcPal.buttonHighlightText : qgcPal.buttonHighlightText) : (Constants.isABLUOApp ? (control.enabled ? "#efefef" : "#4d4d4d") : qgcPal.buttonText)
    property color _currentContentColorSecondary: (checked || pressed) ? (Constants.isABLUOApp ? "#9d9d9d" : qgcPal.buttonText) : (Constants.isABLUOApp ? qgcPal.buttonHighlight : qgcPal.buttonHighlight)
