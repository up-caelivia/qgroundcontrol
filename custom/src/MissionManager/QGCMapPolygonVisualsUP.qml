        ...
        Repeater {
            ...
            delegate: Item {
                ...
                function _setPosition() {
                    ...
                    _distanceLab.coordinate = _vertices[index].atDistanceAndAzimuth(distance / 2, azimuth)

                    _distanceLab.distance = distance
                ...
                Component.onCompleted: {
                    ...
                    _distanceLab = distanceLabel.createObject(mapControl)
                    _splitHandle.vertexIndex = index

                    _setPosition()
                    mapControl.addMapItem(_splitHandle)
                    mapControl.addMapItem(_distanceLab)
