...
public:
    ...
    QString         commandDescription          (void) const final { return tr("Mission Setup Information"); }
    QString         commandName                 (void) const final { return tr("Mission Setup Information"); }
